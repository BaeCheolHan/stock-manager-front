            ...
            <div class="flex" style="justify-content: space-between; font-size: 12px;">
              <div class="w-50">
                ...
                <div>
                  ...
                  <span v-if="stock.national == 'KR'"
                        :style="setPriceColor(stock)">{{ Math.floor(Number(stock.avgPrice)).toLocaleString('ko-KR') }}</span>
                  <span v-else
              ...
              <div class="t-a-r w-55">
                <div class="flex" style="justify-content: right">
                  ...
                  <span>(</span>
                  <p :class="UiService.setUpDownArrowClass(stock.compareToYesterdaySign)" :style="UiService.setColorStyle(stock.compareToYesterdaySign)">
                    {{ Math.floor(((stock.compareToYesterday / stock.nowPrice) * 100) * 100) / 100 }}%</p>
                  <span>)</span>
                </div>
                <div class="flex" style="justify-content: right">
                  <span>현재가 : </span>
